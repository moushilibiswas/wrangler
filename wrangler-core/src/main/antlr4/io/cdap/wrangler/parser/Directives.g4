...
directive
 : command
  (   codeblock
    ...
    | numberRanges
    | properties
    | byteSizeArg      // Add byteSizeArg support
    | timeDurationArg  // Add timeDurationArg support
  )*?
  ;
...
value
 : String | Number | Column | Bool | BYTE_SIZE | TIME_DURATION  // Add TIME_DURATION / / Add BYTE_SIZE
 ;
